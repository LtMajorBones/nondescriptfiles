...
mkdir securehub/VAR_FILES/SPOKES/$1_PEERING

mkdir securehub/SPOKES/$1_PEERING

PART=(${1//-/ })

cat << EOF > securehub/SPOKES/$1_PEERING/main.tf
...
cat << EOF > securehub/VAR_FILES/SPOKES/$1_PEERING/peering.tfvars
...
vnet_peering = {
  DevPeerSet = {
    ...
    peer-two = {
      ...
      remote_virtual_network_id    = "/subscriptions/f502c51f-dea4-4b90-9d7a-f157aa3e9d02/resourceGroups/rg-rtlntwkspkmclindev000/providers/Microsoft.Network/virtualNetworks/vnet-rtlcorespkmclindev000"
      allow_virtual_network_access = true
      allow_forwarded_traffic      = true
...
touch securehub/VAR_FILES/SPOKES/$1_PEERING/.gitkeep

touch securehub/SPOKES/$1_PEERING/.gitkeep